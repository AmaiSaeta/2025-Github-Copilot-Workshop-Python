...
class DeliveryManager:
    ...
    def __init__(self, recipe_list_so: RecipeListSO):
        ...
        self._spawn_recipe_timer_max: float = DELIVERY_SPAWN_RECIPE_TIMER_MAX
        self._waiting_recipes_max: int = DELIVERY_WAITING_RECIPES_MAX
        self._successful_recipes_amount: int = 0
        self._game_manager = game_manager or KitchenGameManager.get_instance()
    ...
    DELIVERY_SPAWN_RECIPE_TIMER_MAX = 5.0
    DELIVERY_WAITING_RECIPES_MAX = 4

    class RecipeEventArgs(EventArgs):
        def __init__(self, recipe: 'RecipeSO'):
            self.recipe = recipe
# 使用例
